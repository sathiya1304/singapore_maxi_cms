          ...
          >
            ...
            <Box sx={{ mb: 2 }}>
              ...
              <Box sx={{ display: "flex", flexDirection: "row", gap: 1 }}>
                <Paper sx={{ width: "300px", height: "1000px" }}>
                  <Typography
                    variant="h4"
                    className="nunito_font"
                    color="primary"
                      ...
                      >
                        ...
                        >
                          ...
                          {newContentItems.map((item, index) => (
                            <GridContainer sx={{ pb: 1, marginTop: "10px" }}>
                              <Grid item xs={3} md={3}>
                                <FormControl
                                  size="small"
                                  fullWidth
                              ...
                              {item.contenttype === "status" && (
                                <FormControl
                                  size="small"
                                  sx={{ width: "25%", marginTop: "10px" }}
                                  error={Boolean(postError?.content)}
                                >
                                  <InputLabel
                                    sx={{ fontSize: "14px" }}
                                    id="content-label"
                  ...
                  <Grid container spacing={2}>
                    {data?.map((item, index) => (
                      <Grid
                        ...
                        lg={5}
                        key={index}
                        sx={{ width: "100%", position: "relative", mt: 4 }}
                      >
                        <Card
                          sx={{
                            width: "100%",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <MenuItem value="model" sx={{ fontSize: "14px" }}>
                    Model
                  </MenuItem>
                  <MenuItem value="model_type" sx={{ fontSize: "14px" }}>
                    Model Type
                  </MenuItem>
                  <MenuItem value="passengers" sx={{ fontSize: "14px" }}>
                    Passengers
                  </MenuItem>
            ...
            {contentType === "model_type" && (
              ...
              >
                ...
                >
                  ...
                  {modelType.map((item) => (
                    <MenuItem key={item.id} value={item.data_uniq_id}>
                      {item.model}
                    </MenuItem>
                  ))}
                </Select>
            ...
            {contentType === "status" && (
              ...
              >
                ...
                >
                  ...
                  <MenuItem value="unavailable" sx={{ fontSize: "14px" }}>
                    Un Available
                  </MenuItem>
                </Select>
                {postError?.content && (
                  <FormHelperText>{postError.content}</FormHelperText>
                )}
              </FormControl>
            )}
          </Box>
